...
function save_and_new_editor_area(){ var tag_name=current_demarcate_element.get(0).tagName.toLowerCase();var new_elem=$("<"+tag_name+"/>");new_elem.insertAfter(current_demarcate_element); $("#demarcate_save").click(); new_elem.addClass("demarcate_temporary");new_elem.click();}
...
var new_elem=$(modifyHtml(curr_value)); new_elem.insertBefore(current_demarcate_element);current_demarcate_element.remove();current_demarcate_element=new_elem; hide_editor(e)
