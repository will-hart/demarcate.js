...
if(tag_name=='div'&&node.hasClass("toc")){result+="\n[TOC]\n\n";return;}} 
...
var doSave=function(){ var tag_name=demarcate.current_element.get(0).tagName.toLowerCase();var curr_value=demarcate.current_editor.val();var new_elem=$("<"+tag_name+"/>",{text:curr_value}); var html_value=modifyHtml(curr_value); if(tag_name=="th"||tag_name=="td"){demarcate.current_element.html(new_elem.html());}else{new_elem.insertBefore(demarcate.current_element);demarcate.current_element.remove();demarcate.current_element=new_elem;}}
