...
elem=$(elem);var tag_name=elem.get(0).tagName.toLowerCase(); if(tag_name in _tag_dict){ var md="";if(tag_name=="pre"){md=demarcate.markdown.code(elem);}else{md=demarcate.markdown.parseChildren(elem);} 
...
var doSave=function(){ var tag_name=demarcate.current_element.get(0).tagName.toLowerCase();var curr_value=demarcate.current_editor.val();var new_elem=$("<"+tag_name+"/>");var raw_html=modifyHtml(curr_value); if(raw_html.substring(0,3)=="<p>"){raw_html=raw_html.substring(3,raw_html.length-4);} 
