...
*      run on "textr" (http://to-textr.com/) but has now been released   *
*      into the wild as open source software.                            *
*                                                                        *
*      Version 2.0 constitutes a major redesign, removing the jQuery     *
*      dependency and switching the editor over to use contentEditable.  *
*      This provides a much richer and more modular editing experience!  * 
*      As much as possible the original API has been maintained to keep  * 
*      backwards compatibility but there are some breaking changes.      * 
*      Please review the documentation for more.                         *
*                                                                        *
...
(function(t, w, d) {
	...
	var editor = null,	
		...
		focusEditor = function () {
			...
			editor.focus();
			var elem = w.getSelection().baseNode;
			if (elem.nodeType === 3) {
		...
		createMenuButton = function (text, action, tooltip) {
	...
	// save the demarcate object to window
...
(function(demarcate) {
	...
	var parse = function (elem) { 
		 ...
		 */
		getTextFromNode = function(elem, allowNewlines, preserveWhitespace) {
